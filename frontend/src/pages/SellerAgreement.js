  ...
  async function loadBusiness() {
    try {
      ...
      if (idToUse) {
        ...
        if (!data) {
          console.warn("Business not found yet (null response)");
        } else {
          businessData = data;
        }
      } else {
  ...
  async function handleAgree() {
    ...
    try {
      ...
      try {
        ...
        console.warn("No auth session yet. Continuing agreement flow by businessId.");
      }
      ...
      // ✅ FIXED: removed .select() and strict data check
